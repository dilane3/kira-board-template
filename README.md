# 🚀 Kira Board — Kanban Board Template

**Kira Board** is a beautifully crafted **kanban board** built with [**Rasengan.js**](https://rasengan.dev) and [**Shadcn UI**](https://ui.shadcn.com).
...
git clone https://github.com/rasengan-dev/kira-board-template.git

# Move into the directory
cd kira-board-template
...
All the components are stored in the `components/` folder. You can edit the components there and the template will update automatically.
